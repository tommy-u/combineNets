...
int main(){
  ...
  struct fann *bnn = fann_create_standard(num_layers, num_input, num_output);  
  struct fann *cnn = fann_create_standard(num_layers + 1, num_input, 2*num_output, num_output);  
